...
```{r, fig.height=12, fig.width=8, dpi=250}
...
```{r, fig.height=8, fig.width=10, dpi=250}
...
rate %>% 
  ...
  labs(title="Cea mai mare rată a taxării marginale", 
       x="An", y="% din venit", caption="Sursa: OECD, Tabelul I.7", colour="Ţară") + 
...
df %>% #filter(!grepl("Croatia|Elvetia", geo)) %>% 
  ...
  labs(title="Încasările din impozitul pe venit", 
       x=NULL, y="Procent din PIB", caption="Sursa: Eurostat, gov_10a_taxag") +
  scale_color_manual(values=culori[-6]) 
```
...
```{r, fig.height=10, fig.width=10, dpi=250}
...
```{r, fig.width=10, fig.height=12, dpi=250}
