...
Cote de 10 % şi 16 % pe orice sumă care depăşeşte 2200 EURO brut. Se strâng în total `r round(insumare(coefs=c(0.0, 0.1, 0.16), praguri=c(5300, 2200*60)), 2)` miliarde RON, cu 3.42 miliarde mai mulţi bani decât în 2021. Îl vom rotunji la 3 miliarde RON, notând că valoarea va fi mult mai mare în 2023, aşa ne luăm o marjă de eroare semnificativă.

### Scenariul II

Cote de 10 şi 19 % pe orice sumă depăşeşte 2200 EURO brut. Se strâng `r round(insumare(coefs=c(0, 0.1, 0.19), praguri=c(5300, 2200*60)), 2)` miliarde RON. Acest lucru înseamnă încă 5.28 miliarde de RON la buget. Îl vom rotunji la 5 miliarde.

### Scenariul III

Sugestia noastră personală cu cote de 16 şi 21 %. Se strâng `r round(insumare(coefs=c(0.0, 0.16, 0.21), praguri=c(5300, 2200*60)), 2)` miliarde RON. Acest lucru înseamnă mai mult cu 19.42 miliarde de RON. Îl vom rotunji la 18 de miliarde RON, o marjă semnificativă.

### Scenariul IV

Scenariul slovac, cu trepte de 19 şi 25 %. Se strâng `r round(insumare(coefs=c(0.0, 0.16, 0.21), praguri=c(5300, 2200*60)), 2)` miliarde RON. Acest lucru înseamnă 28.35 miliarde de RON. Îl vom rotunji la 28 de miliarde RON.
